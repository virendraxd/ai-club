...
function AICellPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 flex">
      ...
      <button 
        className="md:hidden fixed top-4 left-4 z-50 bg-[#002147] text-white p-2 rounded-md"
        ...
        <nav>
          <ul className="space-y-4 text-sm font-bold uppercase tracking-wide">
            {[
              ...
              <li key={link.label}>
                <a href={link.href} className="block p-3 rounded-lg hover:bg-orange-600 transition-all text-blue-100 hover:text-white" onClick={() => setIsSidebarOpen(false)}>
                  {link.label}
                </a>
              </li>
            ))}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="max-w-full w-full mx-auto px-4 py-16 overflow-hidden">
          ...
          <div className="-mx-4 px-4 py-16 bg-gray-100 mb-20">
            <div className="max-w-7xl mx-auto">
              <div className="grid md:grid-cols-2 gap-16">
                <div className="bg-white p-4 sm:p-10 rounded-2xl shadow-lg border-t-4 border-orange-500">
                ...
                <div className="bg-white p-4 sm:p-10 rounded-2xl shadow-lg border-t-4 border-[#002147]">
                  <h3 className="text-3xl font-bold text-[#002147] mb-6 flex items-center gap-3">
          ...
          <section id="values" className="mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
              {[
                ...
                <div key={idx} className="group bg-white p-4 sm:p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-2">
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-[#002147] text-white">
                        <th className="p-2 sm:p-4 font-bold uppercase tracking-wider text-sm">S.No.</th>
                        <th className="p-2 sm:p-4 font-bold uppercase tracking-wider text-sm">Name</th>
                        <th className="p-2 sm:p-4 font-bold uppercase tracking-wider text-sm">Designation</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        <tr key={i} className="hover:bg-blue-50 transition-colors">
                          <td className="p-2 sm:p-4 font-medium text-gray-500">{i + 1}</td>
                          <td className="p-2 sm:p-4 font-bold text-[#002147]">{member.name}</td>
                          <td className="p-2 sm:p-4 text-gray-600 italic">{member.role}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          <div className="-mx-4 px-4 py-16 bg-blue-900 text-white mb-20">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="max-w-6xl mx-auto text-blue-100 text-left sm:text-center mb-12 leading-relaxed">
                <p>
                    ...
                    <table className="w-full text-left border-collapse">
                      ...
                      <tbody className="divide-y divide-white/10">
                        <tr className="hover:bg-white/5 transition-colors">
                          ...
                          <td className="p-4"><a href="#" className="text-orange-400 hover:underline">View</a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
          ...
          <section id="roadmap" className="mb-20">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white p-4 sm:p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100">
                <div className="grid gap-6">
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between group">
                      ...
                      <span className={`${item.color} text-white px-3  rounded-full text-xs font-black uppercase tracking-tighter shadow-sm`}>
                        {item.status}
                      </span>
                    </div>
                  ))}
          ...
          <section id="contact" className="pb-20">
            <div className="bg-[#002147] rounded-4xl sm:rounded-[3rem] p-4 sm:p-10 md:p-20 text-white relative overflow-hidden shadow-2xl">
              <div className="relative z-10 grid md:grid-cols-2 gap-16">
                ...
                <div className="bg-white/5 backdrop-blur-lg p-4 sm:p-8 rounded-3xl border border-white/10">
